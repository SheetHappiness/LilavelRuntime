...
Implementation SHA: `196c5f9477807a7dced528090193aa3127ffc0be`
...
reuse rather than claiming rollback or success.
...
- Runtime: Ruff, format, Pyright, and 47 tests PASS; focused P4-B 25 tests PASS.
...
P4-C may proceed from the implementation SHA above. It must preserve explicit
